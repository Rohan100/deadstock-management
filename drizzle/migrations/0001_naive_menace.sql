CREATE TYPE "public"."item_condition_enum" AS ENUM('New', 'Good', 'Used', 'Damaged');--> statement-breakpoint
CREATE TYPE "public"."item_status_enum" AS ENUM('Active', 'Low Stock', 'Out of Stock');--> statement-breakpoint
...
ALTER TABLE "items" DROP CONSTRAINT "unique_item";--> statement-breakpoint
ALTER TABLE "items" DROP CONSTRAINT "items_category_id_categories_category_id_fk";
--> statement-breakpoint
ALTER TABLE "items" DROP CONSTRAINT "items_sub_category_id_sub_categories_sub_category_id_fk";
--> statement-breakpoint
...
ALTER TABLE "items" ADD COLUMN "sku" varchar(100) NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "quantity" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "min_stock" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "unit_price" numeric(10, 2) NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "status" "item_status_enum" DEFAULT 'Active' NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "department_id" integer;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "supplier_id" integer;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "location" varchar(150) NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "condition" "item_condition_enum" DEFAULT 'New' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "vendors" ADD COLUMN "vendorType" varchar(50) NOT NULL;--> statement-breakpoint
...
ALTER TABLE "items" DROP COLUMN "model_number";--> statement-breakpoint
ALTER TABLE "items" DROP COLUMN "specifications";--> statement-breakpoint
ALTER TABLE "items" DROP COLUMN "unit_of_measurement";--> statement-breakpoint
